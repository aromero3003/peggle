...
bool lista_es_vacia(const lista_t *l) { return l->prim == NULL; }

void *lista_primero(const lista_t *l) { return l->prim->elem; }
...
bool lista_iter_al_final(const lista_iter_t *i) { return i->act == NULL; }
...
bool lista_iter_avanzar(lista_iter_t *i) {
    if (lista_iter_al_final(i)) return false;
...
void lista_iter_destruir(lista_iter_t *i) { free(i); }
