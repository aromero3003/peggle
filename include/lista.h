...
// void *lista_buscar(const lista_t *l, const void *dato, int (*cmp)(const void
// *a, const void *b));,

// void *lista_borrar(lista_t *l, const void *dato, int (*cmp)(const void *a,
// const void *b));

void lista_recorrer(const lista_t *l, bool (*f)(void *dato, void *extra),
                    void *extra);
